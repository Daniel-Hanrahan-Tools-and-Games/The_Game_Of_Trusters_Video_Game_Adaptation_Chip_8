...
Gold coin is shown when the player gets a gold coin 1 is only option on Chip 8 Keypad. 

Enemy gets shown when in combat 1 to talk and 2 to attack on Chip 8 Keypad.
